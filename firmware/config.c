...
static const uint8_t config_device_id_el_motor[12] = { 0x0F, 0x00, 0x22, 0x00, 0x0B, 0x43, 0x4E, 0x57, 0x37, 0x39, 0x35, 0x20 };
static const uint8_t config_device_id_az_motor[12] = { 0x01, 0x80, 0x02, 0x00, 0x13, 0x43, 0x4E, 0x47, 0x33, 0x38, 0x32, 0x20 };
...
void config_init(void)
{
  ...
  if(CONFIG_MATCH_DEVICE_ID(config_device_id, config_device_id_el_motor))
  {
    /*
      "SCOT Motor I/F" - April 2020
      Clutch Driver & Limit switch ports fitted.
    */
    config_can_address_prefix |= CAN_ADDRESS_PREFIX_ELEVATION;
    config_can_address_prefix |= CAN_ADDRESS_PREFIX_MOTOR;
  }
  else if(CONFIG_MATCH_DEVICE_ID(config_device_id, config_device_id_az_motor))
  {
    /*
      "SCOT Motor I/F" - April 2020
      No clutch driver or limit switch port fitted
    */
